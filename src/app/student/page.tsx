    ...
    <div className="space-y-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-300">
          Ваш персональный ИИ-помощник готов помочь с выбором вуза
        </p>
      </div>
        ...
        <NeomorphicCard>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{stats.totalScore}</p>
            </div>
        ...
        <NeomorphicCard>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{stats.recommendations}</p>
            </div>
        ...
        <NeomorphicCard>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{stats.savedInstitutions}</p>
            </div>
            <div className="w-12 h-12 bg-gradient-primary rounded-xl flex items-center justify-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <GradientCard>
          <CardHeader>
            ...
            <CardDescription>
              Получите персональные рекомендации по поступлению
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Наш ИИ проанализирует ваши результаты ЕГЭ, учтёт достижения и подберёт 
              идеальные варианты для поступления.
            </p>
            <Link href="/assistant">
        ...
        <GradientCard>
          <CardHeader>
            ...
            <CardDescription>
              Изучите доступные учебные заведения
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Просмотрите список вузов и колледжей, изучите программы обучения 
              и требования для поступления.
            </p>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Ваши недавние анализы и рекомендации
          </CardDescription>
        </CardHeader>
        <CardContent>
